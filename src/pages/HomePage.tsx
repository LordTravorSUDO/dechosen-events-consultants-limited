...
import { CORE_DIVISIONS, OPERATIONS_MATRIX, COMPANY_INFO, UNSPLASH_IMAGES } from '../data/siteData';
...
// Route path → ROUTES constant mapping for CORE_DIVISIONS.pageId values
const DIVISION_ROUTE_MAP: Record<string, string> = {
  'home':                ROUTES.home,
  'culinary-school':     ROUTES.culinarySchool,
  'catering':            ROUTES.catering,
  'event-management':    ROUTES.eventManagement,
  'cleaning':            ROUTES.facilityCleaning,
  'consultancy':         ROUTES.consultancy,
  'ceo':                 ROUTES.chefPeter,
      ...
      <section className="py-8 sm:py-12 bg-[#F4F6F8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-12 gap-4 lg:gap-6">
            ...
            <div className="col-span-12 lg:col-span-8 relative overflow-hidden bg-[#1B365D] rounded-2xl border border-slate-700 shadow-xl min-h-[440px] flex flex-col justify-between p-6 sm:p-10 group">
              ...
              <div className="relative z-10 max-w-2xl mt-8">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Link
                    to={ROUTES.consultancy}
                    className="bg-white/10 hover:bg-white/20 text-white border border-white/20 font-bold text-xs uppercase tracking-wider px-6 py-3 rounded flex items-center space-x-2 transition-colors"
                  >
            ...
            <div className="col-span-12 lg:col-span-4 bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 flex flex-col justify-between shadow-md hover:shadow-xl transition-all">
              <div>
                ...
                <ul className="space-y-2.5 text-xs text-slate-600 mb-6">
                  {[
                    'Startup Blueprinting & Concept Launch',
                    'Menu Engineering & Cost Control',
                    'Staffing & SOP Operational Audits',
              ...
              <Link
                to={ROUTES.consultancy}
                className="text-[#1B365D] hover:text-[#D99B26] font-bold text-[11px] uppercase tracking-widest border-b-2 border-[#1B365D] hover:border-[#D99B26] w-max pb-1 transition-colors flex items-center space-x-1"
              >
            ...
            {/* BENTO ITEM 3: CHEF PETER (4 Cols) */}
              ...
              <div className="relative z-10 flex flex-col justify-between h-full space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex flex-wrap gap-2">
                    {['VIP Experience', 'Master Chef', 'International'].map((tag) => (
                      <span key={tag} className="bg-white/20 text-white text-[10px] font-bold px-2.5 py-1 rounded border border-white/20">
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <Link
                    to={ROUTES.chefPeter}
                    className="block w-full bg-[#1B365D] hover:bg-[#0F172A] text-white text-xs font-bold uppercase tracking-wider py-2.5 rounded transition-colors text-center"
                  >
                    READ CEO PROFILE
                  </Link>
                </div>
            ...
            <Link
              to={ROUTES.culinarySchool}
              className="col-span-12 sm:col-span-6 lg:col-span-4 bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between shadow-md hover:shadow-xl transition-all group"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[10px] font-bold text-slate-400 uppercase">DIVISION 01</span>
                </div>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[10px] font-bold text-slate-400 uppercase">DIVISION 02</span>
                </div>
                <h4 className="font-serif font-bold text-xl text-[#1B365D] group-hover:text-[#D99B26] transition-colors mb-2">
            ...
            <Link
              ...
              className="col-span-12 sm:col-span-6 lg:col-span-6 bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between shadow-md hover:shadow-xl transition-all group"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="w-10 h-10 rounded bg-[#D99B26]/10 border border-[#D99B26]/30 text-[#D99B26] flex items-center justify-center font-bold">
                  ...
                  <span className="text-[10px] font-bold text-slate-400 uppercase">DIVISION 03</span>
                </div>
                <h4 className="font-serif font-bold text-xl text-[#1B365D] group-hover:text-[#D99B26] transition-colors mb-2">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[10px] font-bold text-slate-400 uppercase">DIVISION 04</span>
                </div>
                <h4 className="font-serif font-bold text-xl text-[#1B365D] group-hover:text-[#D99B26] transition-colors mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4">
                <Link
                  to={ROUTES.chefPeter}
                  className="bg-[#1B365D] hover:bg-[#0F172A] text-white font-bold text-xs uppercase tracking-wider px-8 py-3.5 rounded shadow-md inline-flex items-center space-x-2 transition-colors"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {CORE_DIVISIONS.map((div) => (
              <Link
                key={div.id}
                to={DIVISION_ROUTE_MAP[div.pageId] ?? ROUTES.home}
                className="group bg-white rounded-xl overflow-hidden border border-slate-200 shadow-md hover:shadow-2xl transition-all duration-300 flex flex-col justify-between transform hover:-translate-y-1"
              >
                <div>
                  ...
                  <div className="p-6 space-y-3">
                    ...
                    <p className="text-xs text-slate-600 leading-relaxed font-medium">{div.shortDesc}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-200 text-xs text-slate-700">
                {OPERATIONS_MATRIX.map((row, idx) => (
                  <tr key={idx} className="hover:bg-[#F4F6F8] hover:border-l-4 hover:border-l-[#D99B26] transition-all duration-200 group">
                    <td className="py-5 px-6 font-serif font-bold text-sm text-[#1B365D] group-hover:text-[#D99B26]">{row.division}</td>
                    <td className="py-5 px-6 font-semibold text-slate-800">{row.targetAudience}</td>
                    <td className="py-5 px-6 font-medium text-[#4A777A]">{row.strategicDeliverable}</td>
                    <td className="py-5 px-6 text-slate-500 text-right max-w-xs">{row.details}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="lg:hidden space-y-4">
            {OPERATIONS_MATRIX.map((row, idx) => {
              ...
              return (
                <div key={idx} className="bg-[#F4F6F8] rounded-lg border border-slate-200 overflow-hidden shadow-xs">
                  <button
                  ...
                  >
                    <div>
                      <span className="text-[10px] font-bold text-[#D99B26] uppercase">DIVISION</span>
                      <h4 className="font-serif font-bold text-base text-[#1B365D]">{row.division}</h4>
                    </div>
                    {isExpanded ? (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#0F172A] p-8 rounded-xl border border-slate-700 shadow-xl space-y-4 hover:border-[#D99B26] transition-colors group">
              ...
              <h3 className="font-serif font-bold text-xl text-white">Integrated Operational Ecosystem</h3>
            ...
            <div className="bg-[#0F172A] p-8 rounded-xl border border-slate-700 shadow-xl space-y-4 hover:border-[#D99B26] transition-colors group">
              ...
              <h3 className="font-serif font-bold text-xl text-white">Scalable Capabilities</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
            ...
            <div className="bg-[#0F172A] p-8 rounded-xl border border-slate-700 shadow-xl space-y-4 hover:border-[#D99B26] transition-colors group">
              ...
              <h3 className="font-serif font-bold text-xl text-white">Standardized Quality & Safety</h3>
              <p className="text-xs text-slate-300 leading-relaxed">

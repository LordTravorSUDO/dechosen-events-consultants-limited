...
import { TRAINING_COURSES, PAGE_HERO_IMAGES, UNSPLASH_IMAGES } from '../data/siteData';
import { Calendar, CheckCircle2, Award, GraduationCap, Utensils, Sparkles, ArrowRight, ShieldCheck } from 'lucide-react';
...
export const CulinarySchoolPage: React.FC = ({ onNavigate, onOpenBooking }) => {
  return (
    <div className="font-sans">
      
      {/* 
        IMAGE PLACEHOLDER:
        Replace this image with a professional photograph of chef instructors
        teaching students in a modern commercial kitchen at Dechosen Culinary School.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed max-w-2xl">
              Certified culinary, confectionery, domestic staff, and kitchen hygiene education designed to transform passionate students into industry-ready hospitality professionals and estate leaders.
            </p>
            ...
            {TRAINING_COURSES.map((course, index) => (
              ...
              >
                <div>
                  ...
                  <h3 className="font-serif font-bold text-2xl text-[#1B365D] mb-2">
                    {course.title}
                  </h3>
            ...
            <div className="bg-[#1B365D] text-white rounded-xl p-8 border-2 border-[#D99B26]/50 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-serif font-bold text-2xl text-white mb-2">
                  Institutional & On-Site Group Training
                </h3>
